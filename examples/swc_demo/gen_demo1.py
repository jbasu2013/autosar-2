...
if __name__ == '__main__':
    ...
    amber.rte.generator.TypeGenerator(partition).genTypeHeader('derived')
    amber.rte.generator.ComponentGenerator(partition).genHeaders('derived')
    amber.os.generator.EventGenerator(partition).genHeader('derived')
    generator = amber.os.generator.TaskGenerator(partition)
    generator.genHeader('derived')
    generator.genSource('derived')
    print("Done")